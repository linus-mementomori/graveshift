...
**Nightfall** is an installable web app that turns any phone into a professional Mafia/Werewolf
...
Existing apps mostly solve #2 and stop there. Nightfall solves the **theatre** of it — the part
