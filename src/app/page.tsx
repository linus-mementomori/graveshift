 ...
 *
 * The app screen above is deliberately almost wordless. That's right for a host
 * holding a phone in a dark room, and useless to a search engine, which can only
 * rank text it can read. This section sits under the CTAs so it never costs the
 * host a tap, and gives crawlers something real: what the app does, how the game
 * works, and answers to the questions people actually search for.
 *
...
function AboutContent() {
  const faqs: [string, string][] = [
    [
      ...
      'Between 5 and 20. It works best with 8 to 15. Below that there is not enough discussion for deduction to work, and above 18 the conversation gets hard to hold together.',
    ],
    [
  ...
  return (
    <section className="mt-24 border-t border-[var(--border-subtle)] pt-10">
      ...
      <p className="mt-3 text-sm leading-relaxed text-[var(--text-secondary)]">
        ...
        app that does all of that for you. It deals the roles, walks the night order, and works out
        who actually died once protections and potions are accounted for. Then it tells you exactly
